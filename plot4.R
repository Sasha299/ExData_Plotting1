...
## Plot4 creates file Plot1.png
png(filename = "plot4.png", width = 480, height = 480, units = "px", bg = "transparent")
par(mfrow = c(2, 2))
## First Graph
plot(y$Date, y$Global_active_power, type='l', xlab="Gobal Active Power (kilowatts)", ylab="Frequency")
## Second graph
plot(y$Date, y$Voltage, type='l', xlab="datetime", ylab="Voltage")      
## Third Graph
plot(y$Date, y$Sub_metering_1, type='l', xlab="", ylab="Energy sub metering", col="black")
